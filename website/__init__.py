...
def create_app():
    ...
    if ENV == "dev":
        ...
        app.debug = False
        app.config["SQLALCHEMY_DATABASE_URI"] = 'postgresql://euxwieiklbgchh:e00ad230c19ff4480182593902d73fd637beec3e305050f77d15160aa4fdedf3@ec2-54-217-15-9.eu-west-1.compute.amazonaws.com:5432/d43llm3tjc9p51'
